...
namespace WindowsFormsApplication1
{
    public partial class Form2 : Form
    {
        ...
        public void MostrarCombo()
        {
            ...
            metodos_usuario.consulta("SELECT * FROM `seccion` INNER JOIN estante ON seccion.id_estante = estante.id_estante", "seccion");
            comboBox1.DataSource = metodos_usuario.ds.Tables["seccion"];

            comboBox1.DisplayMember = "des_seccion";
            comboBox1.ValueMember = "id_seccion";
